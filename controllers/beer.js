...
exports.getBeers = function(req, res) {
  ...
  Beer.find({ userId: req.user.username }, function(err, beers) {
    if (err)
      return res.send(err);
...
exports.getBeer = function(req, res) {
  ...
  Beer.find({ userId: req.user.username, _id: req.params.beer_id }, function(err, beer) {
    if (err)
      return res.send(err);
